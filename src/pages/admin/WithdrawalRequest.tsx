...
export default function WithdrawalRequest() {
  return (
    <div className="w-full animate-in fade-in duration-300">
      <div className="mb-4">
        <h2 className="text-[#2b3a4a] text-[1.2rem] font-medium">Withdrawal Requests</h2>
        <div className="text-[0.7rem] text-gray-400 mt-1">Home / Withdrawal Requests</div>
      </div>

      <div className="bg-white border rounded shadow-sm p-6 overflow-x-auto min-h-[60vh]">
        <h3 className="text-[#104e92] text-[0.95rem] font-medium mb-5">Pending Withdrawal Approvals</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-4">
          ...
          <input type="text" placeholder="Search by Req ID" className="border border-gray-200 rounded px-3 py-1.5 text-sm outline-none focus:border-[#0d6efd]" />
          ...
          <table className="w-full text-sm text-left border-collapse">
            <thead>
              <tr className="border-b border-gray-200 text-[#212529]">
                ...
                <th className="py-3 px-2 font-bold w-[150px]">Action</th>
              </tr>
            </thead>
            <tbody>
